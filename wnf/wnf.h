...
typedef ULONG64 WNF_CHANGE_STAMP;
typedef ULONG64 PWNF_DELIVERY_DESCRIPTOR;
typedef ULONG64 PWNF_TYPE_ID;

#define WNF_NODE_TYPE_SCOPE_MAP          0x901
#define WNF_NODE_TYPE_SCOPE_INSTANCE     0x902
#define WNF_NODE_TYPE_CONTEXT_HEADER     0x903
#define WNF_NODE_TYPE_STATE_DATA         0x904
#define WNF_NODE_TYPE_PROCESS_CONTEXT    0x906
#define WNF_NODE_TYPE_HEAP               0x911
#define WNF_NODE_TYPE_SUBSCRIPTION       0x912
#define WNF_NODE_TYPE_SUBSCRIPTION_TABLE 0x914
...
typedef struct _WNF_USER_SUBSCRIPTION {
    ...
    ULONG64                           SubscribedEventSet;
    PWNF_SERIALIZATION_GROUP          SerializationGroup;
    ULONG64                           UserSubscriptionCount;
    HANDLE                            ThreadId;
